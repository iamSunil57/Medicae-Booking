              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    Maiores sint voluptatum molestiae unde quod aut nam facilis
                    quam aliquid dolorem! Illum vitae dolore sunt accusamus.
                    Cum, quia aliquam! Voluptatibus laboriosam voluptatum sed.
                    Cum aspernatur numquam assumenda atque similique? Error,
                    omnis culpa vel asperiores in delectus a corporis quidem
                    molestias sunt.
                  </p>
            ...
            lg:gap-[30px]"
              ...
              <div className="flex gap-[30px] justify-end">
                ...
                <div className="mt-[30px]">
                  <img className="w-full mb-[30px]" src={heroImg02} alt="Img" />
                  <img className="w-full" src={heroImg03} alt="Img" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="xl:w-[670px]">
                ...
                <ul className="pl-4 mb-8">
                  ...
                  <li className="text__para">
                    ...
                    the online scheduling tool to book/select an appointment
                    time.
                  </li>
                </ul>
